...
--
ALTER TABLE `tbl_detail_pesanan`
  MODIFY `id_detail_pesanan` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `tbl_pesanan`
  MODIFY `id_pesanan` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;
...
--
ALTER TABLE `tbl_rekomendasi`
  MODIFY `id_rekomen` int(7) NOT NULL AUTO_INCREMENT;
